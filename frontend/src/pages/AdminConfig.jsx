          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className="fg">
              ...
              <textarea 
                ...
                placeholder="Ví dụ: Bạn là trợ lý AI thông thái và thân thiện, chuyên cung cấp thông tin du lịch và kinh doanh tại Khoinghiep.today..." 
      ...
      <div className="card" style={{ maxWidth: '600px', margin: '2rem auto 0', textAlign: 'left' }}>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBlockStart: 0, marginBlockEnd: '1rem', lineHeight: 1.5 }}>
            Tải lên các tài liệu văn bản để bổ sung kiến thức về Khoinghiep.today, các chính sách, cẩm nang hay thông tin địa phương Khoinghiep.today. AI sẽ đọc và sử dụng thông tin trong các tệp này để trả lời hội viên.
          </p>
